...
const fan = { id: genId('n_'), type:'Load', name:'Fan Bank', Vreq:12, I_typ:5, I_idle:1, I_max:10, critical:true, x: 640, y: 280 } as const
const cpu = { id: genId('n_'), type:'Load', name:'CPU', Vreq:0.9, I_typ:120, I_idle:24, I_max:220, critical:true, x: 860, y: 140 } as const
