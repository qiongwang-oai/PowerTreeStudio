        ...
        <div className="flex max-h-[90vh] w-full max-w-[1952px] flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-xl">
          <div className="flex items-center justify-between border-b px-4 py-3">
            <div>
              ...
              <div className="text-sm text-slate-600">Click the chevron buttons to expand the subsystems. Use Cmd+F (macOS) or Ctrl+F (Windows/Linux) to search within this window.</div>
